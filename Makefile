...
EDITAVEIS_SOURCES = informacoes.tex resumo.tex abstract.tex \
					simbolos.tex apendices.tex anexos.tex
EDITAVEIS_FILES = $(addprefix $(EDITAVEIS_DIR)/, $(EDITAVEIS_SOURCES))

CONTEUDO_DIR = $(addprefix $(EDITAVEIS_DIR)/, conteudo)
CONTEUDO_SOURCES = introducao.tex estrategia_da_producao.tex \
					processo.tex projeto.tex \
					ferramenta_de_gestao.tex melhoria.tex
